...
def define_G(input_nc, output_nc=2, init_type='normal', init_gain=0.02):
    net = SEIFNet(input_nc, output_nc) #最终版的网络
...
class SEIFNet(Backbone):
    ...
    def __init__(self, input_nc, output_nc,
        ...
        # adjust for input channels
        self.encoder.conv1 = nn.Conv2d(input_nc, 64, kernel_size=7, stride=2, padding=3, bias=False)
